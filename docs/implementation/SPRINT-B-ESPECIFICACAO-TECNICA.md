...
#### B3.4 — pendente, não iniciada

- Testes finais de integração cobrindo B3.2+B3.3 em conjunto, e documentação de encerramento da Sprint B3.
